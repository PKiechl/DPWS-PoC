...
#ifndef ON_OFF_RETARGET_HELPER_H
#define ON_OFF_RETARGET_HELPER_H
...
class OnOffRetargetHelper
{
  public:
     ...
     *        to.
     */
    OnOffRetargetHelper(std::string protocol, Address address);
...
#endif /* ON_OFF_RETARGET_HELPER_H */
